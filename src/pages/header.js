  ...
  return (
    <header>
      <nav className={`navbar`}>
        <div className="logo"><a href='/'>Merry Meal</a></div>
        ...
        <ul className={`nav-links ${isMobileMenuOpen? "nav-links-mobile":""}`}>
          ...
          {isLoggedIn ? (
            userRole === 'ADMIN' ? (
              <>
                <li><a href='/adminMeal'>Meals Management</a></li>
              ...
              <>
                <li><a href='/mealUpload'>Upload Meal</a></li>
                <li><a href='/partnerProfile'>Profile</a></li>
                <li><a className='logout' onClick={handleLogout}>Logout</a></li>
              </>
            ) : userRole === 'VOLUNTEER' ? (
              <>
                <li><a href='/careGiver'>Give Care</a></li>
                <li><a href='/getOrder'>Take Order</a></li>
                <li><a href='/volunteerProfile'>Profile</a></li>
                <li><a className='logout' onClick={handleLogout}>Logout</a></li>
              </>
            ) : (

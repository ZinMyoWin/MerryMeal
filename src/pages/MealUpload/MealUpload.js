      ...
      <div className='mu-container'>
        ...
        <form onSubmit={this.handleSubmit}>
            <div className="form-group">
              <label className='mu-label' htmlFor="name">Name:</label>
              <input
                className='mu-input'
                type="text"
                name="name"
            ...
            <div className="form-group">
              <label className='mu-label' htmlFor="mealDescription">Description:</label>
              <input
                className='mu-input'
                type="text"
            ...
            <div className="form-group">
              <label className='mu-label' htmlFor="ingredient">Ingredients:</label>
              <input
                className='mu-input'
                type="text"
                name="ingredient"
            ...
            <div className="form-group">
              <label className='mu-label' htmlFor="image">Meal Image:</label>
              <input
                className='mu-input'
                type="file"
                name="image"
            ...
            <div className="form-group">
              <label className='mu-label' htmlFor="price">Price:</label>
              <input
                className='mu-input'
                type="number"
                name="price"
            ...
            <button className='mu-btn' type="submit">Upload Meal</button>
          </form>
      </div>
    );
  }
